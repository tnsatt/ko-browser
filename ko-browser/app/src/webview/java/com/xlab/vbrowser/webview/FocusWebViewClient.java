...
import com.xlab.vbrowser.browser.LocalizedContent;
import com.xlab.vbrowser.utils.IntentUtils;
...
*/
    ...
    public WebResourceResponse shouldInterceptRequest(WebView view, final WebResourceRequest request) {
        ...
        if (request.isForMainFrame()) {
            ...
            if (currentURL != null && requestURL != null
                    &&UrlUtils.urlsMatchExceptForTrailingSlash(currentURL, requestURL)) {
                view.post(new Runnable() {
                    @Override
                    public void run() {
                        if (callback != null) {
                            callback.onURLChanged(currentURL, false);
                        }
                    }
                });
            }
            ...
            Log.d("shouldInterceptRequest", requestURL + " " + request.hasGesture());
            view.post(new Runnable() {
                @Override
                public void run() {
                    if (callback != null) {
    ...
    public void onPageStarted(WebView view, String url, Bitmap favicon) {
        ...
        if (Settings.getInstance(view.getContext()).shouldEnterSpeedMode()) {
            mSystemWebView.enableLoadingImage(false);
        }
    ...
    public void onPageCommitVisible(WebView view, String url) {
        ...
        //mSystemWebView.enableLoadingImage(true);
    ...
    public void onPageFinished(WebView view, final String url) {
        ...
        if (callback != null) {
            ...
            if (!UrlUtils.isInternalErrorURL(viewURL) && viewURL != null) {
                Log.d("onPageFinished", "onUrlChanged " + viewURL);
    ...
    public boolean shouldOverrideUrlLoading(WebView view, String url) {
        ...
        if (UrlUtils.isWhitelistUrl(url)) {
            return false;
        }
