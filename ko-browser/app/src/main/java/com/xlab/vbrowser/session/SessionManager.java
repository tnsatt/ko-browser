    ...
    private void createSessionFromIntent(Context context, SafeIntent intent) {
        ...
        if (Intent.ACTION_VIEW.equals(action)) {
            ...
            if (intent.hasExtra(HomeScreen.ADD_TO_HOMESCREEN_TAG)) {
                ...
                createSession(context, Source.HOME_SCREEN, intent, Z.parseUri(intent.getDataString()), blockingEnabled);
            } else {
                createSession(context, Source.VIEW, intent, Z.parseUri(intent.getDataString()));
            }
