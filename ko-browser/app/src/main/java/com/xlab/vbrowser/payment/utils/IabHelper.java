...
package com.xlab.vbrowser.payment.utils;
...
//                mService = IInAppBillingService.Stub.asInterface(service);
                ...
                try {
                    ...
                    int response = -1;//mService.isBillingSupported(3, packageName, ITEM_TYPE_INAPP);
                    ...
                    response = -1;//mService.isBillingSupported(5, packageName, ITEM_TYPE_SUBS);
                    if (response == BILLING_RESPONSE_RESULT_OK) {
                    ...
                    if (mSubscriptionUpdateSupported) {
                        ...
                        response = -1;//mService.isBillingSupported(3, packageName, ITEM_TYPE_SUBS);
                        if (response == BILLING_RESPONSE_RESULT_OK) {
...
//        mService = null;
    ...
    public void launchPurchaseFlow(Activity act, String sku, String itemType, List<String> oldSkus,
        ...
        try {
            ...
            if (oldSkus == null || oldSkus.isEmpty()) {
                ...
                buyIntentBundle = null;//mService.getBuyIntent(3, mContext.getPackageName(), sku, itemType,
                       // extraData);
            } else {
                ...
                buyIntentBundle = null;//mService.getBuyIntentToReplaceSkus(5, mContext.getPackageName(),
    ...
    void consume(Purchase itemInfo) throws IabException {
        ...
        try {
            ...
            int response = -1;//mService.consumePurchase(3, mContext.getPackageName(), token);
            if (response == BILLING_RESPONSE_RESULT_OK) {
