 ...
 */
public class DownloadManagerContextMenu {
    ...
    public static void show(final @NonNull Context context, final @NonNull String title, final boolean isCompleted, final IActionMenu actionMenu) {
        ...
        setupMenu(dialog, menu, title, isCompleted, actionMenu);
    ...
    private static void setupMenu(final @NonNull Dialog dialog,
        ...
        navigationView.inflateMenu(R.menu.menu_download_manager_context);
        navigationView.getMenu().findItem(R.id.menu_open).setVisible(isCompleted);
