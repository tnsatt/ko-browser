...
/* package */ class ResizableKeyboardViewDelegate {
    ...
    /* package */ ResizableKeyboardViewDelegate(@NonNull View view, @NonNull AttributeSet attrs) {
        ...
        final TypedArray styleAttributeArray = view.getContext().getTheme().obtainStyledAttributes(
                attrs,
                com.xlab.vbrowser.R.styleable.ResizableKeyboardViewDelegate,
                0, 0);

        try {
            idOfViewToHide = styleAttributeArray.getResourceId(com.xlab.vbrowser.R.styleable.ResizableKeyboardViewDelegate_viewToHideWhenActivated, -1);
            shouldAnimate = styleAttributeArray.getBoolean(com.xlab.vbrowser.R.styleable.ResizableKeyboardViewDelegate_animate, false);
        } finally {
    ...
    private int calculateDifferenceBetweenHeightAndUsableArea() {
        ...
        return delegateView.getHeight() - rect.bottom;
    }
}
